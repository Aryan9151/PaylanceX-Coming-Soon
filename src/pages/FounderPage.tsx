  ...
  return (
    <section className="relative px-6 py-24">
      <div className="mx-auto max-w-4xl">
        <Reveal>
          <SectionHeading eyebrow="About" title="About Aryan Gupta" />
        </Reveal>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4">
                    <p className="text-lg font-light leading-relaxed text-neon-100/80 sm:text-xl">
                      ...
                      remove complexity, not create it — and that the best products are the ones
                    ...
                    <p className="text-base font-light leading-relaxed text-neon-100/60">
                      ...
                      future-ready technology. Not just launching products, but crafting solutions
                      that genuinely make everyday experiences better.
                    </p>
                    <p className="text-base font-light leading-relaxed text-neon-100/60">
  ...
  return (
    <section className="relative px-6 py-24">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          <SectionHeading eyebrow="Origin Story" title="Why I Started PaylanceX" />
        </Reveal>
        ...
        <Reveal delay={100}>
          <div className="mt-12 glass-strong relative overflow-hidden rounded-3xl p-8 shadow-glass sm:p-12">
            ...
            <div className="relative space-y-6">
              ...
              <p className="text-lg font-light leading-relaxed text-neon-100/80">
                Instead of accepting them as normal, I decided to start building. PaylanceX is the
                beginning of that journey — a company focused on creating thoughtful, reliable, and
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <Reveal delay={100}>
          <div className="mt-12 relative">
            <div className="glass-strong relative overflow-hidden rounded-3xl p-10 text-center shadow-glass sm:p-16">
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-neon-300/80 to-transparent" />
...
const CORE_VALUES = [
  {
    ...
    title: 'Innovation',
    description:
      'Pushing boundaries to create technology that feels ahead of its time — not for the sake of novelty, but to solve real problems.',
  },
  {
    icon: ShieldCheck,
    title: 'Trust',
    description:
      'Earning confidence through transparency, reliability, and integrity in everything we build and every decision we make.',
  },
  {
    icon: Sparkles,
    title: 'Simplicity',
    description:
      'Removing complexity so people can focus on what matters. Great technology should feel effortless.',
  },
  {
    icon: Telescope,
    title: 'Long-term Thinking',
    description:
      'Building with the next decade in mind. Sustainable, durable solutions over short-term wins.',
  },
];
              ...
              <Reveal key={value.title} delay={i * 100}>
                <div className="group glass relative h-full overflow-hidden rounded-3xl p-8 transition hover:ring-1 hover:ring-neon-300/30">
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-3 text-sm font-light leading-relaxed text-neon-100/60">
                      {value.description}
                    </p>
                  </div>
                </div>
...
const JOURNEY_STEPS = [
  {
    ...
    title: 'The Spark',
    description:
      'Observing everyday challenges in how people interact with digital services — and deciding that "normal" was not good enough.',
  },
  {
    icon: Rocket,
    title: 'The Decision',
    description:
      'Choosing to build rather than wait. Moving from observation to action, with a commitment to creating better experiences.',
  },
  {
    icon: ShieldCheck,
    title: 'The Foundation',
    description:
      'Establishing PaylanceX on principles of trust, simplicity, and long-term thinking — the foundation for everything that follows.',
  },
  {
    icon: Telescope,
    title: 'The Road Ahead',
    description:
      'Building toward a future where PaylanceX creates technology used and trusted by millions across India and beyond.',
  },
];
              ...
              <Reveal key={step.title} delay={i * 100}>
                <div className="relative flex gap-6">
                  ...
                  <div className="glass flex-1 rounded-3xl p-6 sm:p-8">
                    <div className="flex items-center gap-3">
                      <span className="text-xs font-semibold uppercase tracking-wider text-neon-300">
                        Step {i + 1}
                      </span>
                    </div>
                    ...
                    <p className="mt-2 text-sm font-light leading-relaxed text-neon-100/60">
                      {step.description}
                    </p>
                  </div>
                </div>
...
function Connect() {
  return (
    <section className="relative px-6 py-24">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          <SectionHeading eyebrow="Get in Touch" title="Connect with Me" />
        </Reveal>
          ...
          <div className="mt-12 glass-strong relative overflow-hidden rounded-3xl p-8 shadow-glass sm:p-12">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-neon-400 to-neon-600 px-8 py-4 text-sm font-semibold text-white shadow-neon transition-all duration-300 hover:shadow-neon-lg hover:-translate-y-0.5 sm:w-auto"
              >
                <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
                <Linkedin className="h-4 w-4" />
                Connect on LinkedIn
              ...
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full glass px-7 py-4 text-sm font-medium text-neon-100/80 transition hover:text-white hover:ring-1 hover:ring-neon-300/40 sm:w-auto"
              >
