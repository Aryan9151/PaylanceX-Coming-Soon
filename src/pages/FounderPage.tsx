      ...
      <main className="relative z-10 flex flex-1 flex-col">
        ...
        <section className="relative px-6 py-24">
          <div className="mx-auto max-w-3xl">
            <Reveal>
              <div className="glass-strong relative overflow-hidden rounded-3xl p-8 text-center shadow-glass sm:p-12">
                ...
                <h2 className="mt-3 font-display text-2xl font-bold tracking-tight text-gradient sm:text-3xl">
                  Axoryn Technology Pvt. Ltd.
                </h2>
                <p className="mx-auto mt-4 max-w-xl text-base font-light leading-relaxed text-neon-100/60">
                  PaylanceX is a startup developed and owned by Axoryn Technology Pvt. Ltd., an
                  Indian technology company dedicated to building innovative technology products
